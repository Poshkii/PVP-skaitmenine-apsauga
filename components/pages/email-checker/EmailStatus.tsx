                                ...
                                <>
                                    <div className="security-check-container glassmorphism">
                                        ...
                                        <div className="security-status" style={{ marginTop: "24px" }}>
                                            ...
                                            <div className="status-text">
                                                {(dangerEmail || warningEmail) && <h3 className="status-title overflow-text" style={{width:"260px"}} >{email}<br></br>{t('leaked')}</h3>}
                                                {safeEmail && <h3 className="status-title overflow-text" style={{width:"260px"}} >{email}<br></br>{t('safe')}</h3> }
                                                {unknownEmail && <h3 className="status-title overflow-text" style={{width:"260px"}} >{t('badEmail')}</h3> }                        
