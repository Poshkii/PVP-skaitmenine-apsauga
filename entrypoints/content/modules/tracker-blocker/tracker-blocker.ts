...
export class TrackerBlocker extends Module {
    ...
    load(): void {
        console.log("applying fingerprint protection");
        this.applyProtections().catch(err => {
    ...
    private async applyProtections(): Promise<void> {
        ...
        try {
            ...
            if (HTMLCanvasElement) {
                ...
                console.log("HTMLCanvasElement component is unreachable");
            ...
            console.log("window component is unreachable");
            ...
            if (document) {
                ...
                console.log("document component is unreachable");
